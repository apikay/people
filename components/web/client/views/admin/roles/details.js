...
(function() {
  ...
  app.Delete = Backbone.Model.extend({
    ...
    url: function() {
      return '/admin/roles/'+ app.mainView.model.id +'/';
    }
  });
  ...
  app.Details = Backbone.Model.extend({
    ...
    parse: function(response) {
      if (response.role) {
        app.mainView.model.set(response.role);
  ...
  app.Permissions = Backbone.Model.extend({
    ...
    url: function() {
      return '/admin/roles/'+ app.mainView.model.id +'/permissions/';
    },
    parse: function(response) {
      if (response.role) {
        app.mainView.model.set(response.role);
  ...
  app.MainView = Backbone.View.extend({
    ...
    initialize: function() {
      app.mainView = this;
      this.model = new app.Role( JSON.parse( unescape($('#data-record').html()) ) );
